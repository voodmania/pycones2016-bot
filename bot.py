...
def get_all_days_keyboard():
    return InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text=INIT_MSG, callback_data='days')]])

def get_days_keyboard():
    kb = []
    for day in DAYS:
        kb.append([InlineKeyboardButton(text=day.name, callback_data='schedules {}'.format(day.value))])
